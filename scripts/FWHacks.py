...
class FWHacks(BaseEstimator, TransformerMixin):
    ...
    '''
    def __init__(self,round_weights = False, normalize_condition_number = True):
    ...
    def optimize_weights(self, X_diffs, y_diffs):
        ...
        enet = ElasticNet(alpha = .001, l1_ratio = 0, positive=False)
        enet.fit(A, y_diffs)
        print enet.coef_
        return 1, enet.coef_
